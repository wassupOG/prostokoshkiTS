      ...
      <Accordion>
        ...
        <AccordionDetails>
          <div>
            ...
            хлоргексидин, аугментин, амоксициллин, азикан (вет аптека), витамин Б12 в ампулах (человеческая аптека). Капли амит и суролан, таблетки синулокс или
            кладакса, суспензия стоп-кокцид (вет аптека), гепатолюкс (вет аптека). Шприцы 20 мл, 10 мл, 2 мл, 1 мл.
          </div>
          <div>
            💟 Вакцины. Мультифел 4
            <br />
